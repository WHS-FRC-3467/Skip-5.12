...
public class IntakeSubsystem extends SubsystemBase {
  ...
  public void periodic() {
    ...
    if(m_intakeMotor2.getMotorOutputPercent() > 0.1 || m_intakeMotor2.getMotorOutputPercent() < -0.1){
      m_running = true;
    }
    else{
      m_running = false;
    ...
    SmartDashboard.putNumber("Intake Current Draw", m_intakeMotor2.getSupplyCurrent());
  }
