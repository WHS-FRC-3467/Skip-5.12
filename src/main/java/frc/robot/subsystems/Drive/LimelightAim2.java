...
public class LimelightAim2 extends CommandBase {
  ...
  @Deprecated
  public LimelightAim2(DriveSubsystem drive, Limelight limelight) {
  ...
  public LimelightAim2(DriveSubsystem drive, Limelight limelight, boolean waitForTarget, boolean ranging){
    m_limelight = limelight;
    m_drive = drive;
