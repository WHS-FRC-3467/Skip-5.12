...
<<<<<<< HEAD
      ...
      new AutoShoot(m_shooter, m_tower, ShooterConstants.kTarmacVelocity, ShooterConstants.kTarmacGains, Value.kForward).withTimeout(1.2).raceWith(new RunCommand(m_intake::fullRunIntake, m_intake)),
